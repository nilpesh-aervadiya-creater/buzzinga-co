...
export default function Footer() {
  return (
    <footer className="site-footer bg-white pt-10 min-[810px]:pt-0">
      <Container className="flex max-w-[1200px] flex-col items-start gap-10 px-10 pb-[90px] min-[810px]:gap-[52px] min-[810px]:px-10 xl:px-0">
        <div className="grid w-full grid-cols-1 gap-y-6 min-[810px]:grid-cols-4 min-[810px]:gap-x-4 min-[810px]:gap-y-0 min-[810px]:justify-center max-[810px]:text-center">
